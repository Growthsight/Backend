...
<body >
    ...
    <div class="row" style="padding: 25px 25px 25px 25px;">
             ...
             <div class="col-lg-1 col-centered" style="background-color:#FFFFFF; width:100%; padding:5px 5px 5px 5px;">
                 ...
                 <div style="margin: 0 auto; width:340px; padding: 15px 15px 15px 15px;">
                     <h1>Generating Report</h1>
                 <img src="hex-loader2.gif" alt="Loading Gif" style="width:304px;height:228px;">
                 </br>
                 </br>
                 We Are Analyzing The Plot Of Land. This May Take A While...We Will Email You When It's Done!
                 </br>
                    </br>
                </div>
             </div>
