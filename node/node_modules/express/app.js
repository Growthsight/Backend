...
app.get('/stateData/:state?:crop', function(req, res){

   console.log("Got a GET request for job creation");
   var usState = req.params.state
   var crop = req.params.crop
      ...
      try {
         response= ""
        db.all("SELECT * FROM state_data WHERE state=\""+usState+"\" AND crop=\""+crop+"\"", function(err, rows) {  
                rows.forEach(function (row) {  
                    console.log(row.data);  
                    response = {year: row.year, description: row.description, value: row.value};    
                })  
              });   
