...
var server = app.listen(8081, function () {
  ...
  create_email("ksparakis@gmail.com", "123415131")
...
var send_email = function(email,html)
{
      ...
      execCommand = 'curl -s --user \'api:key-5e1c1b2d4261fa432d1296b1984526f4\' https://api.mailgun.net/v3/mg.sparakis.com/messages -F from=\'Growthsight <Growthsight@sparakis.com>\' -F to='+email+' -F subject=\'Your GrowthSight Report Is Ready...\' -F html=\"'+html+'\"';
...
var create_email = function(email, viewId){
   ...
   // +viewId+"</a></p> <p>Growthsight is an OpenSource project under the MIT License. We set out with the mission of conquering the massive collection of open data available to the public. These sources include everything from NASA data to Forecast API's. We want to provide to farmers a way to analyze potential land purchases, along with people in third world countries the technology to predict how well a specific crop would grow under natural conditions in their backyard.  </p> <table class='callout'> <tr> <td class='callout-inner primary'> <p>Please feel free to contribute and make this project something even more amazing.</p> </td> <td class='expander'></td> </tr> </table> <table class='callout'> <tr> <td class='callout-inner secondary'> <table class='row'> <tbody> <tr> <th class='small-12 large-6 columns first'> <table> <tr> <th>     <center data-parsed=''><div style='background:#26A65B;width:200px;height:30px;padding-top:15px'><a href='https://github.com/Growthsight/Growthsight' align='center' style='color:#FFF; ' class='text-center'>Growthsight on GitHub</a></div></center> </body> </html>"
    html = "<h1>Hey, "+emailName+" Your Growth Sight Score Is Ready.../h1> <p>Follow This link to access your report: <a href='http://growthsight.sparakis.com/view/"+viewId+"' align='center' style='color:#26A65B; ' class='text-center'>http://growthsight.sparakis.com/view/"+viewId+"</a></p>"  
   //html ="HIIIII"
    //console.log(html);
